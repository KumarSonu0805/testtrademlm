                ...
                <section class="content">
                    <div class="container-fluid">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button type="button" class="btn btn-sm btn-primary btn-update" value="<?= $single['id'] ?>">Update Ticket Status</button>
                                                                    <?php } ?>
                        ...
                        <div class="row hidden" id="formdiv">
                            <div class="col-md-12">
                                <div class="card light-bg">
                                    <div class="card-header">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <?= form_open_multipart('settings/updateticket/'); ?>
                                                    <div class="form-group">
                                                        <?= create_form_input('textarea','message','Reply',true,'',['rows'=>'3','id'=>'message']); ?>
                                                    </div><br>
                                                    <div class="form-group hidden">
                                                        <?= create_form_input('select','status','Status',true,'1',['id'=>'status'],[2=>'Open',1=>'Close']); ?>
                                                    </div><br>
                                                    <div class="form-group ">
                                                        <input type="hidden" name="id" id="id">
                                                        <input type="submit" class="btn btn-success waves-effect waves-light" name="updateticket" value="Update Ticket">
