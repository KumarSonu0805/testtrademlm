...
<a href="https://api.whatsapp.com/send/?phone=7004756264&text=Hello,%20I%20am%20interested%20in%20your%20services"
   class="btn-whatsapp"
   target="_blank"
...
<script srv="<?= file_url('assets/js/owl.carousel.min.js'); ?>"></script>
         ...
         document.addEventListener("DOMContentLoaded", function () {
           ...
           counters.forEach(counter => {
             const updateCount = () => {
               ...
               if (count < target) {
                 count += increment;
                 counter.innerText = "₹" + (count > target ? target : count) + "k";
