                                ...
                                <div class="card light-bg">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <?= form_open_multipart('wallet/savetorewardwallet/', 'id="myform"'); ?>
                                                    ...
                                                    <div class="form-group">
                                                        <select name="" id="type" class="form-control">
                                                            <option value="add">Add Reward</option>
                                                            <option value="reverse">Reverse Reward</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <?php
                                                    ...
                                                    <button type="submit" class="btn btn-sm btn-success" name="savetorewardwallet" value="Save" id="savebtn">Save to Reward Wallet</button>
                                                <?= form_close(); ?>
                                            </div>
                                        </div>
                                    </div>
