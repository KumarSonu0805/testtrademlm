                                                ...
                                                <div class="table-responsive" id="result">
                                                    <table class="table data-table" id="bootstrap-data-table-export">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $purchases=$purchases;
                                                                if(is_array($purchases)){$i=0;
                                                                    foreach($purchases as $single){
                                                                        $i++;
                                                                        $filesrc=file_url($single['file']);
                                                                        $file='<button type="button" class="btn btn-sm btn-info mb-1 view" data-toggle="modal" data-target="#mediumModal" value="'.$filesrc.'">View</button>';
                                                            ?>
                                                            <tr>
                                                                <td><?php echo $i; ?></td>
                                                                <td><?php echo date('d-m-Y',strtotime($single['date'])); ?>
