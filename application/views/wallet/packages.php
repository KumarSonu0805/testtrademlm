                                                    ...
                                                    <table class="table table-condensed">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Amount</th>
                                                                <th>Discount</th>
                                                                <?php /*?><th>Withdrawal Amount</th><?php */?>
                                                                <th>Action</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php /*?><td><?= $single['min_withdrawal']; ?></td><?php */?>
                                                                <td>
                                                                    <button type="button" class="btn btn-xs btn-info edit-btn" value="<?= $single['id']; ?>" data-value="<?= $single['min_withdrawal']; ?>" data-package="<?= $single['package']; ?>" data-discount="<?= $single['discount']; ?>"><i class="fa fa-edit"></i></button>
                                                                </td>
                                                            </tr>
                                                            <?php
                                                                    }
                                                ...
                                                <?= form_open_multipart('wallet/updatepackage/'); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <input type="submit" class="btn btn-success waves-effect waves-light" name="updatepackage" value="Update Packages">
                ...
                <script>
                    $(document).ready(function(e) {
                        ...
                        $('.cancel-btn').click(function(){
                            $('#package,#discount,#min_withdrawal,#id').val('');
