<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
 class Template {
    ...
    function load($folder, $view, $data=array("title"=>"Page")) {
		...
		if(isset($data['treechart']) && $data['treechart']===true){
			$this->loadtreechart();
		}
        ...
        $userphoto=file_url('includes/dist/img/user2-160x160.jpg');
        if($getuser['status']===true){
            $userphoto=$getuser['user']['photo'];
        }
	...
	function loadtreechart(){
		$this->styles['file'][]="includes/custom/highchart.css";
		$this->top_script['link'][]="https://code.highcharts.com/highcharts.js";
		$this->top_script['link'][]="https://code.highcharts.com/modules/sankey.js";
		$this->top_script['link'][]="https://code.highcharts.com/modules/organization.js";
