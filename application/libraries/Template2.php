...
class Template2 {
    ...
    function load($folder, $view, $data=array("title"=>"Page"),$type="page") {
		...
		$contentpath=$root.$folder.'2/'.$view;
		$footerpath=$root.'/includes2/footer';
        ...
        if($type=='page'){
            $this->ci->load->view($root.'includes2/top-section',$data);     
            $this->ci->load->view($root.'includes2/wrapper');
            $this->ci->load->view($root.'includes2/bottom-section');
        }
        elseif($type=='auth'){
            $this->ci->load->view($root.'includes2/top-section',$data);       
            $this->ci->load->view($root.'includes2/wrapper');
	...
	function loadtoastr(){
		$this->styles['file'][]="includes2/plugins/toastr/toastr.min.css";
		$this->bottom_script['file'][]="includes2/plugins/toastr/toastr.min.js";
	}
	...
	function loaddatatable(){
		$this->styles['link'][]="https://cdn.datatables.net/1.13.8/css/jquery.dataTables.min.css";
		$this->content_script['link'][]="https://cdn.datatables.net/1.13.8/js/jquery.dataTables.min.js";
	}
